-- 20260125145400_fix_player_stats_view.sql
-- Update player_statistics view to only count finished matches
...
select 
  ...
  -- Solo contamos partidos FINALIZADOS
...
-- Changed: Filter matches by status = 'finished'
left join public.matches m on m.team_id = p.team_id and m.status = 'finished'
